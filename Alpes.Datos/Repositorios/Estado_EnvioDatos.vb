...
Namespace Repositorios
    Public Class Estado_EnvioDatos
        ...
        Public Function Insertar(ByVal entidad As Estado_Envio) As Integer
            ...
            Using cn As OracleConnection = _conexionOracle.ObtenerConexion()
                Using cmd As New OracleCommand("PKG_ESTADO_ENVIO.SP_INSERTAR_ESTADO_ENVIO", cn)
                    ...
                    idGenerado = Convert.ToInt32(cmd.Parameters("P_ESTADO_ENVIO_ID").Value.ToString())
                End Using
            End Using
        ...
        Public Sub Actualizar(ByVal entidad As Estado_Envio)
            Using cn As OracleConnection = _conexionOracle.ObtenerConexion()
        ...
        Public Function ObtenerPorId(ByVal id As Integer) As Estado_Envio
            Dim entidad As Estado_Envio = Nothing
        ...
        Public Function Listar() As List(Of Estado_Envio)
            Dim lista As New List(Of Estado_Envio)()
            ...
            Using cn As OracleConnection = _conexionOracle.ObtenerConexion()
                Using cmd As New OracleCommand("PKG_ESTADO_ENVIO.SP_LISTAR_ESTADOS_ENVIO", cn)
                    ...
                    Using dr As OracleDataReader = cmd.ExecuteReader()
                        While dr.Read()
                            lista.Add(MapearEstadoEnvio(dr))
                        End While
                    End Using
                End Using
            End Using
        ...
        Public Function Buscar(ByVal criterio As String, ByVal valor As String) As List(Of Estado_Envio)
            Dim lista As New List(Of Estado_Envio)()
        ...
        Private Function MapearEstadoEnvio(ByVal dr As OracleDataReader) As Estado_Envio
            Dim entidad As New Estado_Envio()
