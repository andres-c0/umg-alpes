...
Namespace Repositorios
    Public Class Tipo_PromocionDatos
        ...
        Public Function Insertar(ByVal entidad As Tipo_Promocion) As Integer
            ...
            Using cn As OracleConnection = _conexionOracle.ObtenerConexion()
                Using cmd As New OracleCommand("PKG_TIPO_PROMOCION.SP_INSERTAR_TIPO_PROMOCION", cn)
                    ...
                    cmd.Parameters.Add("P_TIPO_PROMOCION_ID", OracleDbType.Int32).Direction = ParameterDirection.Output

                    cmd.ExecuteNonQuery()

                    idGenerado = Convert.ToInt32(cmd.Parameters("P_TIPO_PROMOCION_ID").Value.ToString())
                End Using
            End Using
        ...
        Public Sub Actualizar(ByVal entidad As Tipo_Promocion)
            Using cn As OracleConnection = _conexionOracle.ObtenerConexion()
                Using cmd As New OracleCommand("PKG_TIPO_PROMOCION.SP_ACTUALIZAR_TIPO_PROMOCION", cn)
                    cmd.CommandType = CommandType.StoredProcedure
        ...
        Public Sub Eliminar(ByVal id As Integer)
            Using cn As OracleConnection = _conexionOracle.ObtenerConexion()
                Using cmd As New OracleCommand("PKG_TIPO_PROMOCION.SP_ELIMINAR_TIPO_PROMOCION", cn)
                    cmd.CommandType = CommandType.StoredProcedure

                    cmd.Parameters.Add("P_TIPO_PROMOCION_ID", OracleDbType.Int32).Value = id
        ...
        Public Function ObtenerPorId(ByVal id As Integer) As Tipo_Promocion
            Dim entidad As Tipo_Promocion = Nothing

            Using cn As OracleConnection = _conexionOracle.ObtenerConexion()
                Using cmd As New OracleCommand("PKG_TIPO_PROMOCION.SP_OBTENER_TIPO_PROMOCION", cn)
                    cmd.CommandType = CommandType.StoredProcedure
                    ...
                    Using dr As OracleDataReader = cmd.ExecuteReader()
                        If dr.Read() Then
                            entidad = MapearTipoPromocion(dr)
                        End If
                    End Using
                End Using
            End Using
        ...
        Public Function Listar() As List(Of Tipo_Promocion)
            Dim lista As New List(Of Tipo_Promocion)()

            Using cn As OracleConnection = _conexionOracle.ObtenerConexion()
                Using cmd As New OracleCommand("PKG_TIPO_PROMOCION.SP_LISTAR_TIPO_PROMOCION", cn)
                    cmd.CommandType = CommandType.StoredProcedure
                    ...
                    Using dr As OracleDataReader = cmd.ExecuteReader()
                        While dr.Read()
                            lista.Add(MapearTipoPromocion(dr))
                        End While
                    End Using
                End Using
            End Using
        ...
        Public Function Buscar(ByVal criterio As String, ByVal valor As String) As List(Of Tipo_Promocion)
            ...
            Using cn As OracleConnection = _conexionOracle.ObtenerConexion()
                Using cmd As New OracleCommand("PKG_TIPO_PROMOCION.SP_BUSCAR_TIPO_PROMOCION", cn)
                    cmd.CommandType = CommandType.StoredProcedure
        ...
        Private Function MapearTipoPromocion(ByVal dr As OracleDataReader) As Tipo_Promocion
            Dim entidad As New Tipo_Promocion()

            entidad.TipoPromocionId = Convert.ToInt32(dr("TIPO_PROMOCION_ID"))
