...
Public Class PromocionApiController
    Inherits CrudApiControllerBase(Of Promocion)
    ...
    <HttpPost>
    <Route("")>
    Public Function Create(ByVal entidad As Promocion) As ActionResult
        Return CrearResultado(entidad)
    End Function

    <HttpPut>
    <Route("{id:int}")>
    Public Function Update(ByVal id As Integer, ByVal entidad As Promocion) As ActionResult
    ...
    Protected Overrides Function InsertarEntidad(ByVal entidad As Promocion) As Integer
        Return _servicio.Insertar(entidad)
    End Function

    Protected Overrides Sub ActualizarEntidad(ByVal entidad As Promocion)
    ...
    Protected Overrides Sub AsignarId(ByVal entidad As Promocion, ByVal id As Integer)
        entidad.PromocionId = id
    End Sub
