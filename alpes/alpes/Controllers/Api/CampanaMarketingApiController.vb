...
<RoutePrefix("api/campanas-marketing")>
Public Class CampanaMarketingApiController
    Inherits CrudApiControllerBase(Of CampanaMarketing)

    Private ReadOnly _servicio As CampanaMarketingServicio

    Public Sub New()
        _servicio = New CampanaMarketingServicio()
    End Sub
    ...
    <HttpPost>
    <Route("")>
    Public Function Create(ByVal entidad As CampanaMarketing) As ActionResult
        Return CrearResultado(entidad)
    End Function

    <HttpPut>
    <Route("{id:int}")>
    Public Function Update(ByVal id As Integer, ByVal entidad As CampanaMarketing) As ActionResult
    ...
    Protected Overrides Function InsertarEntidad(ByVal entidad As CampanaMarketing) As Integer
        Return _servicio.Insertar(entidad)
    End Function

    Protected Overrides Sub ActualizarEntidad(ByVal entidad As CampanaMarketing)
    ...
    Protected Overrides Sub AsignarId(ByVal entidad As CampanaMarketing, ByVal id As Integer)
        entidad.CampanaMarketingId = id
    End Sub
