...
<RoutePrefix("api/estados-envio")>
Public Class EstadoEnvioApiController
    Inherits CrudApiControllerBase(Of EstadoEnvio)

    Private ReadOnly _servicio As EstadoEnvioServicio

    Public Sub New()
        _servicio = New EstadoEnvioServicio()
    End Sub
    ...
    <HttpPost>
    <Route("")>
    Public Function Create(ByVal entidad As EstadoEnvio) As ActionResult
        Return CrearResultado(entidad)
    End Function

    <HttpPut>
    <Route("{id:int}")>
    Public Function Update(ByVal id As Integer, ByVal entidad As EstadoEnvio) As ActionResult
    ...
    Protected Overrides Function InsertarEntidad(ByVal entidad As EstadoEnvio) As Integer
        Return _servicio.Insertar(entidad)
    End Function

    Protected Overrides Sub ActualizarEntidad(ByVal entidad As EstadoEnvio)
    ...
    Protected Overrides Sub AsignarId(ByVal entidad As EstadoEnvio, ByVal id As Integer)
        entidad.EstadoEnvioId = id
    End Sub
