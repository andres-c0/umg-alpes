...
<RoutePrefix("api/tipos-promocion")>
Public Class TipoPromocionApiController
    Inherits CrudApiControllerBase(Of TipoPromocion)

    Private ReadOnly _servicio As TipoPromocionServicio

    Public Sub New()
        _servicio = New TipoPromocionServicio()
    End Sub
    ...
    <HttpPost>
    <Route("")>
    Public Function Create(ByVal entidad As TipoPromocion) As ActionResult
        Return CrearResultado(entidad)
    End Function

    <HttpPut>
    <Route("{id:int}")>
    Public Function Update(ByVal id As Integer, ByVal entidad As TipoPromocion) As ActionResult
    ...
    Protected Overrides Function InsertarEntidad(ByVal entidad As TipoPromocion) As Integer
        Return _servicio.Insertar(entidad)
    End Function

    Protected Overrides Sub ActualizarEntidad(ByVal entidad As TipoPromocion)
    ...
    Protected Overrides Sub AsignarId(ByVal entidad As TipoPromocion, ByVal id As Integer)
        entidad.TipoPromocionId = id
    End Sub
