...
<RoutePrefix("api/promociones-producto")>
Public Class PromocionProductoApiController
    Inherits CrudApiControllerBase(Of PromocionProducto)
    ...
    <HttpPost>
    <Route("")>
    Public Function Create(ByVal entidad As PromocionProducto) As ActionResult
        Return CrearResultado(entidad)
    End Function

    <HttpPut>
    <Route("{id:int}")>
    Public Function Update(ByVal id As Integer, ByVal entidad As PromocionProducto) As ActionResult
    ...
    Protected Overrides Function InsertarEntidad(ByVal entidad As PromocionProducto) As Integer
        Return _servicio.Insertar(entidad)
    End Function

    Protected Overrides Sub ActualizarEntidad(ByVal entidad As PromocionProducto)
    ...
    Protected Overrides Sub AsignarId(ByVal entidad As PromocionProducto, ByVal id As Integer)
        entidad.PromocionProductoId = id
    End Sub
