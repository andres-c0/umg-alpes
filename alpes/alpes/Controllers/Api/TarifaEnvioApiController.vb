...
<RoutePrefix("api/tarifas-envio")>
Public Class TarifaEnvioApiController
    Inherits CrudApiControllerBase(Of TarifaEnvio)
    ...
    <HttpPost>
    <Route("")>
    Public Function Create(ByVal entidad As TarifaEnvio) As ActionResult
        Return CrearResultado(entidad)
    End Function

    <HttpPut>
    <Route("{id:int}")>
    Public Function Update(ByVal id As Integer, ByVal entidad As TarifaEnvio) As ActionResult
    ...
    Protected Overrides Function InsertarEntidad(ByVal entidad As TarifaEnvio) As Integer
        Return _servicio.Insertar(entidad)
    End Function

    Protected Overrides Sub ActualizarEntidad(ByVal entidad As TarifaEnvio)
    ...
    Protected Overrides Sub AsignarId(ByVal entidad As TarifaEnvio, ByVal id As Integer)
        entidad.TarifaEnvioId = id
    End Sub
