...
<RoutePrefix("api/reglas-envio-gratis")>
Public Class ReglaEnvioGratisApiController
    Inherits CrudApiControllerBase(Of ReglaEnvioGratis)

    Private ReadOnly _servicio As ReglaEnvioGratisServicio

    Public Sub New()
        _servicio = New ReglaEnvioGratisServicio()
    End Sub
    ...
    <HttpPost>
    <Route("")>
    Public Function Create(ByVal entidad As ReglaEnvioGratis) As ActionResult
        Return CrearResultado(entidad)
    End Function

    <HttpPut>
    <Route("{id:int}")>
    Public Function Update(ByVal id As Integer, ByVal entidad As ReglaEnvioGratis) As ActionResult
    ...
    Protected Overrides Function InsertarEntidad(ByVal entidad As ReglaEnvioGratis) As Integer
        Return _servicio.Insertar(entidad)
    End Function

    Protected Overrides Sub ActualizarEntidad(ByVal entidad As ReglaEnvioGratis)
    ...
    Protected Overrides Sub AsignarId(ByVal entidad As ReglaEnvioGratis, ByVal id As Integer)
        entidad.ReglaEnvioGratisId = id
    End Sub
