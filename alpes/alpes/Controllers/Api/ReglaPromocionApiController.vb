...
<RoutePrefix("api/reglas-promocion")>
Public Class ReglaPromocionApiController
    Inherits CrudApiControllerBase(Of ReglaPromocion)
    ...
    <HttpPost>
    <Route("")>
    Public Function Create(ByVal entidad As ReglaPromocion) As ActionResult
        Return CrearResultado(entidad)
    End Function

    <HttpPut>
    <Route("{id:int}")>
    Public Function Update(ByVal id As Integer, ByVal entidad As ReglaPromocion) As ActionResult
    ...
    Protected Overrides Function InsertarEntidad(ByVal entidad As ReglaPromocion) As Integer
        Return _servicio.Insertar(entidad)
    End Function

    Protected Overrides Sub ActualizarEntidad(ByVal entidad As ReglaPromocion)
    ...
    Protected Overrides Sub AsignarId(ByVal entidad As ReglaPromocion, ByVal id As Integer)
        entidad.ReglaPromocionId = id
    End Sub
