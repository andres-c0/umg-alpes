...
<RoutePrefix("api/politicas-envio")>
Public Class PoliticaEnvioApiController
    Inherits CrudApiControllerBase(Of PoliticaEnvio)

    Private ReadOnly _servicio As PoliticaEnvioServicio

    Public Sub New()
        _servicio = New PoliticaEnvioServicio()
    End Sub
    ...
    <HttpPost>
    <Route("")>
    Public Function Create(ByVal entidad As PoliticaEnvio) As ActionResult
        Return CrearResultado(entidad)
    End Function

    <HttpPut>
    <Route("{id:int}")>
    Public Function Update(ByVal id As Integer, ByVal entidad As PoliticaEnvio) As ActionResult
    ...
    Protected Overrides Function InsertarEntidad(ByVal entidad As PoliticaEnvio) As Integer
        Return _servicio.Insertar(entidad)
    End Function

    Protected Overrides Sub ActualizarEntidad(ByVal entidad As PoliticaEnvio)
    ...
    Protected Overrides Sub AsignarId(ByVal entidad As PoliticaEnvio, ByVal id As Integer)
        entidad.PoliticaEnvioId = id
    End Sub
