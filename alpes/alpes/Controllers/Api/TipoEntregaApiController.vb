...
<RoutePrefix("api/tipos-entrega")>
Public Class TipoEntregaApiController
    Inherits CrudApiControllerBase(Of TipoEntrega)

    Private ReadOnly _servicio As TipoEntregaServicio

    Public Sub New()
        _servicio = New TipoEntregaServicio()
    End Sub
    ...
    <HttpPost>
    <Route("")>
    Public Function Create(ByVal entidad As TipoEntrega) As ActionResult
        Return CrearResultado(entidad)
    End Function

    <HttpPut>
    <Route("{id:int}")>
    Public Function Update(ByVal id As Integer, ByVal entidad As TipoEntrega) As ActionResult
    ...
    Protected Overrides Function InsertarEntidad(ByVal entidad As TipoEntrega) As Integer
        Return _servicio.Insertar(entidad)
    End Function

    Protected Overrides Sub ActualizarEntidad(ByVal entidad As TipoEntrega)
    ...
    Protected Overrides Sub AsignarId(ByVal entidad As TipoEntrega, ByVal id As Integer)
        entidad.TipoEntregaId = id
    End Sub
