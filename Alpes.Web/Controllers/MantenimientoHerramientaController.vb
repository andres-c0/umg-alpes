...
Public Class MantenimientoHerramientaController
    Inherits Controller

    Private ReadOnly _servicio As MantenimientoHerramientaServicio

    Public Sub New()
        _servicio = New MantenimientoHerramientaServicio()
    End Sub

    Function Index() As ActionResult
        Try
            Dim lista As List(Of MantenimientoHerramienta) = _servicio.Listar()
    ...
    Function Obtener(ByVal id As Integer) As ActionResult
        Try
            Dim entidad As MantenimientoHerramienta = _servicio.ObtenerPorId(id)
    ...
    Function Buscar(ByVal valor As String) As ActionResult
        Try
            Dim lista As List(Of MantenimientoHerramienta) = _servicio.Buscar(valor)
    ...
    Function Insertar() As ActionResult
        Try
            ...
            Dim entidad As MantenimientoHerramienta = JsonConvert.DeserializeObject(Of MantenimientoHerramienta)(jsonBody)
    ...
    Function Actualizar() As ActionResult
        Try
            ...
            If entidad Is Nothing OrElse entidad.MantenimientoId <= 0 Then
                Return Json(New With {
                    .success = False,
                    .message = "Debe enviar MantenimientoId para actualizar."
                })
            End If
    ...
    Function Eliminar() As ActionResult
        Try
            ...
            If jObj("MantenimientoId") IsNot Nothing Then
                id = Convert.ToInt32(jObj("MantenimientoId").ToString())
            ...
            If id <= 0 Then
                Return Json(New With {
                    .success = False,
                    .message = "Debe enviar MantenimientoId o id."
                })
            End If
