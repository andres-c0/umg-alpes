...
Public Class HistorialLaboralController
    ...
    Private ReadOnly _servicio As HistorialLaboralServicio

    Public Sub New()
        _servicio = New HistorialLaboralServicio()
    End Sub

    Function Index() As ActionResult
        Dim lista As List(Of HistorialLaboral) = _servicio.Listar()
        Return Json(lista, JsonRequestBehavior.AllowGet)
    End Function

    Function Obtener(ByVal id As Integer) As ActionResult
        Dim entidad As HistorialLaboral = _servicio.ObtenerPorId(id)
    ...
    Function Insertar() As ActionResult
        Try
            ...
            Dim entidad As HistorialLaboral = JsonConvert.DeserializeObject(Of HistorialLaboral)(jsonBody)

            Dim idGenerado As Integer = _servicio.Insertar(entidad)

            Return Json(New With {
                .success = True,
                .message = "Historial laboral insertado correctamente.",
                .id = idGenerado
            })
    ...
    Function Eliminar() As ActionResult
        Try
            ...
            Return Json(New With {
                .success = True,
                .message = "Historial laboral eliminado correctamente."
            })
        Catch ex As Exception
            Return Json(New With {
                .success = False,
