...
Public Class FAQController
    ...
    Private ReadOnly _servicio As FAQServicio

    Public Sub New()
        _servicio = New FAQServicio()
    End Sub

    Function Index() As ActionResult
        Dim lista As List(Of FAQ) = _servicio.Listar()
        Return Json(lista, JsonRequestBehavior.AllowGet)
    End Function

    Function Obtener(ByVal id As Integer) As ActionResult
        Try
            Dim entidad As FAQ = _servicio.ObtenerPorId(id)
    ...
    Function Buscar(ByVal criterio As String, ByVal valor As String) As ActionResult
        Try
            Dim lista As List(Of FAQ) = _servicio.Buscar(criterio, valor)
    ...
    Function Insertar() As ActionResult
        Try
            ...
            Dim entidad As FAQ = JsonConvert.DeserializeObject(Of FAQ)(jsonBody)

            Dim idGenerado As Integer = _servicio.Insertar(entidad)

            Return Json(New With {
                .success = True,
                .message = "FAQ insertada correctamente.",
                .id = idGenerado
            })
        Catch ex As Exception
            Return Json(New With {
