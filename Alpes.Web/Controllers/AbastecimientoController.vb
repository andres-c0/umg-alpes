...
Public Class AbastecimientoController
    ...
    Private ReadOnly _servicio As AbastecimientoServicio

    Public Sub New()
        _servicio = New AbastecimientoServicio()
    End Sub

    Function Index() As ActionResult
        Try
            Dim lista As List(Of Abastecimiento) = _servicio.Listar()
    ...
    Function Obtener(ByVal id As Integer) As ActionResult
        Try
            Dim entidad As Abastecimiento = _servicio.ObtenerPorId(id)
    ...
    Function Buscar(ByVal criterio As String, ByVal valor As String) As ActionResult
        Try
            Dim lista As List(Of Abastecimiento) = _servicio.Buscar(criterio, valor)
    ...
    Function Insertar() As ActionResult
        Try
            ...
            Dim entidad As Abastecimiento = JsonConvert.DeserializeObject(Of Abastecimiento)(jsonBody)
    ...
    Function Actualizar() As ActionResult
        Try
            ...
            If entidad Is Nothing OrElse entidad.AbastecimientoId <= 0 Then
                Return Json(New With {
                    .success = False,
                    .message = "Debe enviar AbastecimientoId para actualizar."
                })
            End If
    ...
    Function Eliminar() As ActionResult
        Try
            ...
            If jObj("AbastecimientoId") IsNot Nothing Then
                id = Convert.ToInt32(jObj("AbastecimientoId").ToString())
            ...
            If id <= 0 Then
                Return Json(New With {
                    .success = False,
                    .message = "Debe enviar AbastecimientoId o id."
                })
            End If
