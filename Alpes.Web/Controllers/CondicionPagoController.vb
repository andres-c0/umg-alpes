...
Public Class CondicionPagoController
    ...
    Private ReadOnly _servicio As CondicionPagoServicio

    Public Sub New()
        _servicio = New CondicionPagoServicio()
    End Sub

    Function Index() As ActionResult
        Try
            Dim lista As List(Of CondicionPago) = _servicio.Listar()
    ...
    Function Obtener(ByVal id As Integer) As ActionResult
        Try
            Dim entidad As CondicionPago = _servicio.ObtenerPorId(id)
    ...
    Function Buscar(ByVal criterio As String, ByVal valor As String) As ActionResult
        Try
            Dim lista As List(Of CondicionPago) = _servicio.Buscar(criterio, valor)
    ...
    Function Insertar() As ActionResult
        Try
            ...
            Dim entidad As CondicionPago = JsonConvert.DeserializeObject(Of CondicionPago)(jsonBody)
    ...
    Function Actualizar() As ActionResult
        Try
            ...
            If entidad Is Nothing OrElse entidad.CondicionPagoId <= 0 Then
                Return Json(New With {
                    .success = False,
                    .message = "Debe enviar CondicionPagoId para actualizar."
                })
            End If
    ...
    Function Eliminar() As ActionResult
        Try
            ...
            If jObj("CondicionPagoId") IsNot Nothing Then
                id = Convert.ToInt32(jObj("CondicionPagoId").ToString())
            ...
            If id <= 0 Then
                Return Json(New With {
                    .success = False,
                    .message = "Debe enviar CondicionPagoId o id."
                })
            End If
