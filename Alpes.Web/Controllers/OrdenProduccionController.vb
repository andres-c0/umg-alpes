...
Public Class OrdenProduccionController
    ...
    Private ReadOnly _servicio As OrdenProduccionServicio

    Public Sub New()
        _servicio = New OrdenProduccionServicio()
    End Sub

    Function Index() As ActionResult
        Try
            Dim lista As List(Of OrdenProduccion) = _servicio.Listar()
    ...
    Function Obtener(ByVal id As Integer) As ActionResult
        Try
            Dim entidad As OrdenProduccion = _servicio.ObtenerPorId(id)
    ...
    Function Buscar(ByVal criterio As String, ByVal valor As String) As ActionResult
        Try
            Dim lista As List(Of OrdenProduccion) = _servicio.Buscar(criterio, valor)
    ...
    Function Insertar() As ActionResult
        Try
            ...
            Dim entidad As OrdenProduccion = JsonConvert.DeserializeObject(Of OrdenProduccion)(jsonBody)
    ...
    Function Eliminar() As ActionResult
        Try
            ...
            If jObj("OrdenProduccionId") IsNot Nothing Then
                id = Convert.ToInt32(jObj("OrdenProduccionId").ToString())
            ...
            If id <= 0 Then
                Return Json(New With {
                    .success = False,
                    .message = "Debe enviar OrdenProduccionId o id."
                })
            End If
