...
Public Class Nomina_DetalleController
    Inherits Controller

    Private ReadOnly _servicio As Nomina_DetalleServicio

    Public Sub New()
        _servicio = New Nomina_DetalleServicio()
    End Sub

    Function Index() As ActionResult
        Dim lista As List(Of Nomina_Detalle) = _servicio.Listar()
        Return Json(lista, JsonRequestBehavior.AllowGet)
    End Function

    Function Obtener(ByVal id As Integer) As ActionResult
        Dim entidad As Nomina_Detalle = _servicio.ObtenerPorId(id)
    ...
    Function Insertar() As ActionResult
        Try
            ...
            Dim entidad As Nomina_Detalle = JsonConvert.DeserializeObject(Of Nomina_Detalle)(jsonBody)
