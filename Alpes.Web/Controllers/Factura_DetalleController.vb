...
Public Class Factura_DetalleController
    ...
    Private ReadOnly _servicio As Factura_DetalleServicio

    Public Sub New()
        _servicio = New Factura_DetalleServicio()
    End Sub

    Function Index() As ActionResult
        Dim lista As List(Of Factura_Detalle) = _servicio.Listar()
        Return Json(lista, JsonRequestBehavior.AllowGet)
    End Function

    Function Obtener(ByVal id As Integer) As ActionResult
        Dim entidad As Factura_Detalle = _servicio.ObtenerPorId(id)
        Return Json(entidad, JsonRequestBehavior.AllowGet)
    End Function

    Function Buscar(ByVal criterio As String, ByVal valor As String) As ActionResult
        Dim lista As List(Of Factura_Detalle) = _servicio.Buscar(criterio, valor)
        Return Json(lista, JsonRequestBehavior.AllowGet)
    End Function
    ...
    Function Insertar() As ActionResult
        Try
            ...
            Dim entidad As Factura_Detalle = JsonConvert.DeserializeObject(Of Factura_Detalle)(jsonBody)

            Dim idGenerado As Integer = _servicio.Insertar(entidad)

            Return Json(New With {
                .success = True,
                .message = "Factura_Detalle insertado correctamente.",
                .id = idGenerado
            })
    ...
    Function Actualizar() As ActionResult
        Try
            ...
            Return Json(New With {
                .success = True,
                .message = "Factura_Detalle actualizado correctamente."
            })
        Catch ex As Exception
            Return Json(New With {
                .success = False,
    ...
    Function Eliminar() As ActionResult
        Try
            ...
            Return Json(New With {
                .success = True,
                .message = "Factura_Detalle eliminado correctamente."
            })
        Catch ex As Exception
            Return Json(New With {
                .success = False,
