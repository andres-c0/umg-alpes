...
Public Class Historial_CompraController
    Inherits Controller

    Private ReadOnly _servicio As Historial_CompraServicio

    Public Sub New()
        _servicio = New Historial_CompraServicio()
    End Sub

    Function Index() As ActionResult
        Dim lista As List(Of Historial_Compra) = _servicio.Listar()
        Return Json(lista, JsonRequestBehavior.AllowGet)
    End Function

    Function Obtener(ByVal id As Integer) As ActionResult
        Dim entidad As Historial_Compra = _servicio.ObtenerPorId(id)
        Return Json(entidad, JsonRequestBehavior.AllowGet)
    End Function

    Function Buscar(ByVal criterio As String, ByVal valor As String) As ActionResult
        Dim lista As List(Of Historial_Compra) = _servicio.Buscar(criterio, valor)
        Return Json(lista, JsonRequestBehavior.AllowGet)
    End Function
    ...
    Function Insertar() As ActionResult
        Try
            ...
            Dim entidad As Historial_Compra = JsonConvert.DeserializeObject(Of Historial_Compra)(jsonBody)
