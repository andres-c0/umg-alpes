...
Public Class PermisoController
    ...
    Private ReadOnly _servicio As PermisoServicio

    Public Sub New()
        _servicio = New PermisoServicio()
    End Sub

    Function Index() As ActionResult
        Dim lista As List(Of Permiso) = _servicio.Listar()
        Return Json(lista, JsonRequestBehavior.AllowGet)
    End Function

    Function Obtener(ByVal id As Integer) As ActionResult
        Dim entidad As Permiso = _servicio.ObtenerPorId(id)
        Return Json(entidad, JsonRequestBehavior.AllowGet)
    End Function

    Function Buscar(ByVal valor As String) As ActionResult
        Dim lista As List(Of Permiso) = _servicio.Buscar(valor)
        Return Json(lista, JsonRequestBehavior.AllowGet)
    End Function
    ...
    Function Insertar() As ActionResult
        Try
            ...
            Dim entidad As Permiso = JsonConvert.DeserializeObject(Of Permiso)(jsonBody)
