...
Public Class ProveedorController
    ...
    Public Function Obtener(ByVal id As Integer) As ActionResult
        Try
            Dim entidad As Proveedor = _servicio.ObtenerPorId(id)
    ...
    Public Function Insertar() As ActionResult
        Try
            ...
            Dim entidad As Proveedor = JsonConvert.DeserializeObject(Of Proveedor)(jsonBody)
    ...
    Public Function Actualizar() As ActionResult
        Try
            ...
            If entidad.ProvId <= 0 Then
                Throw New Exception("Debe enviar un ProvId válido para actualizar.")
            End If
    ...
    Public Function Eliminar() As ActionResult
        Try
            Dim provId As Integer = ObtenerProvIdDesdeRequest()

            If provId <= 0 Then
                Throw New Exception("Debe enviar un ProvId válido para eliminar.")
            End If

            _servicio.Eliminar(provId)
    ...
    Private Function ObtenerProvIdDesdeRequest() As Integer
        Dim id As Integer = 0

        If Integer.TryParse(Convert.ToString(Request("ProvId")), id) AndAlso id > 0 Then
            Return id
        End If

        If Integer.TryParse(Convert.ToString(Request("prov_id")), id) AndAlso id > 0 Then
            Return id
        End If
        ...
        Try
            ...
            Dim token As JToken = obj("ProvId")
    ...
    Private Function LimpiarMensajeError(ByVal mensaje As String) As String
        ...
        If mensaje.Contains("No se puede eliminar el proveedor porque ya tiene ordenes de compra registradas") Then
            Return "No se puede eliminar el proveedor porque ya tiene órdenes de compra registradas."
        End If
