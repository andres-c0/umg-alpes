...
Public Class ProduccionResultadosController
    Inherits Controller

    Private ReadOnly _servicio As ProduccionResultadosServicio

    Public Sub New()
        _servicio = New ProduccionResultadosServicio()
    End Sub

    Function Index() As ActionResult
        Try
            Dim lista As List(Of ProduccionResultados) = _servicio.Listar()
    ...
    Function Obtener(ByVal id As Integer) As ActionResult
        Try
            Dim entidad As ProduccionResultados = _servicio.ObtenerPorId(id)
    ...
    Function Buscar(ByVal criterio As String, ByVal valor As String) As ActionResult
        Try
            Dim lista As List(Of ProduccionResultados) = _servicio.Buscar(criterio, valor)
    ...
    Function Insertar() As ActionResult
        Try
            ...
            Dim entidad As ProduccionResultados = JsonConvert.DeserializeObject(Of ProduccionResultados)(jsonBody)
    ...
    Function Actualizar() As ActionResult
        Try
            ...
            If entidad Is Nothing OrElse entidad.ResultadoId <= 0 Then
                Return Json(New With {
                    .success = False,
                    .message = "Debe enviar ResultadoId para actualizar."
                })
            End If
    ...
    Function Eliminar() As ActionResult
        Try
            ...
            If jObj("ResultadoId") IsNot Nothing Then
                id = Convert.ToInt32(jObj("ResultadoId").ToString())
            ...
            If id <= 0 Then
                Return Json(New With {
                    .success = False,
                    .message = "Debe enviar ResultadoId o id."
                })
            End If
