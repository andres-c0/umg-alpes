...
Public Class ContratoProveedorController
    ...
    Private ReadOnly _servicio As ContratoProveedorServicio

    Public Sub New()
        _servicio = New ContratoProveedorServicio()
    End Sub

    Function Index() As ActionResult
        Try
            Dim lista As List(Of ContratoProveedor) = _servicio.Listar()
    ...
    Function Obtener(ByVal id As Integer) As ActionResult
        Try
            Dim entidad As ContratoProveedor = _servicio.ObtenerPorId(id)
    ...
    Function Buscar(ByVal criterio As String, ByVal valor As String) As ActionResult
        Try
            Dim lista As List(Of ContratoProveedor) = _servicio.Buscar(criterio, valor)
            Return Json(New With {
                .success = True,
                .data = lista
            }, JsonRequestBehavior.AllowGet)
    ...
    Function Insertar() As ActionResult
        Try
            ...
            Dim entidad As ContratoProveedor = JsonConvert.DeserializeObject(Of ContratoProveedor)(jsonBody)
    ...
    Function Actualizar() As ActionResult
        Try
            ...
            If entidad Is Nothing OrElse entidad.ContratoProveedorId <= 0 Then
                Return Json(New With {
                    .success = False,
                    .message = "Debe enviar ContratoProveedorId para actualizar."
                })
            End If
    ...
    Function Eliminar() As ActionResult
        Try
            ...
            If jObj("ContratoProveedorId") IsNot Nothing Then
                id = Convert.ToInt32(jObj("ContratoProveedorId").ToString())
            ...
            If id <= 0 Then
                Return Json(New With {
                    .success = False,
                    .message = "Debe enviar ContratoProveedorId o id."
                })
            End If
