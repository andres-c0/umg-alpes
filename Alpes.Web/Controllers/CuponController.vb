...
Public Class CuponController
    ...
    Function Index() As ActionResult
        Dim lista As List(Of Cupon) = _servicio.Listar()
        Return Json(lista, JsonRequestBehavior.AllowGet)
    End Function

    Function Obtener(ByVal id As Integer) As ActionResult
        Try
            Dim entidad As Cupon = _servicio.ObtenerPorId(id)
    ...
    Function Buscar(ByVal criterio As String, ByVal valor As String) As ActionResult
        Try
            Dim lista As List(Of Cupon) = _servicio.Buscar(criterio, valor)
    ...
    Function Insertar() As ActionResult
        Try
            ...
            Dim entidad As Cupon = JsonConvert.DeserializeObject(Of Cupon)(jsonBody)

            Dim idGenerado As Integer = _servicio.Insertar(entidad)

            Return Json(New With {
                .success = True,
                .message = "Cupon insertado correctamente.",
                .id = idGenerado
            })
        Catch ex As Exception
            Return Json(New With {
