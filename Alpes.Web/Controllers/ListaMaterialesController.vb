...
Public Class ListaMaterialesController
    ...
    Private ReadOnly _servicio As ListaMaterialesServicio

    Public Sub New()
        _servicio = New ListaMaterialesServicio()
    End Sub

    Function Index() As ActionResult
        Dim lista As List(Of ListaMateriales) = _servicio.Listar()
    ...
    Function Obtener(ByVal id As Integer) As ActionResult
        Try
            Dim entidad As ListaMateriales = _servicio.ObtenerPorId(id)
    ...
    Function Buscar(ByVal valor As String) As ActionResult
        Try
            Dim lista As List(Of ListaMateriales) = _servicio.Buscar(valor)
    ...
    Function Insertar() As ActionResult
        Try
            ...
            Dim entidad As ListaMateriales = JsonConvert.DeserializeObject(Of ListaMateriales)(jsonBody)
    ...
    Function Eliminar() As ActionResult
        Try
            ...
            If jObj("ListaMaterialesId") IsNot Nothing Then
                id = Convert.ToInt32(jObj("ListaMaterialesId").ToString())
            ...
            If id <= 0 Then
                Return Json(New With {
                    .success = False,
                    .message = "Debe enviar ListaMaterialesId o id."
                })
            End If
