...
Public Class PagoController
    ...
    Private ReadOnly _servicio As PagoServicio
    ...
    Function Index() As ActionResult
        Dim lista As List(Of Pago) = _servicio.Listar()
        Return Json(lista, JsonRequestBehavior.AllowGet)
    End Function

    Function Obtener(ByVal id As Integer) As ActionResult
        Dim entidad As Pago = _servicio.ObtenerPorId(id)
    ...
    Function Insertar() As ActionResult
        Try
            ...
            Dim entidad As Pago = JsonConvert.DeserializeObject(Of Pago)(jsonBody)
