...
Public Class OrdenProduccionTareaController
    Inherits Controller

    Private ReadOnly _servicio As OrdenProduccionTareaServicio

    Public Sub New()
        _servicio = New OrdenProduccionTareaServicio()
    End Sub

    Function Index() As ActionResult
        Try
            Dim lista As List(Of OrdenProduccionTarea) = _servicio.Listar()
    ...
    Function Obtener(ByVal id As Integer) As ActionResult
        Try
            Dim entidad As OrdenProduccionTarea = _servicio.ObtenerPorId(id)
    ...
    Function Buscar(ByVal criterio As String, ByVal valor As String) As ActionResult
        Try
            Dim lista As List(Of OrdenProduccionTarea) = _servicio.Buscar(criterio, valor)
    ...
    Function Insertar() As ActionResult
        Try
            ...
            Dim entidad As OrdenProduccionTarea = JsonConvert.DeserializeObject(Of OrdenProduccionTarea)(jsonBody)
    ...
    Function Actualizar() As ActionResult
        Try
            ...
            If entidad Is Nothing OrElse entidad.OpTareaId <= 0 Then
                Return Json(New With {
                    .success = False,
                    .message = "Debe enviar OpTareaId para actualizar."
                })
            End If
    ...
    Function Eliminar() As ActionResult
        Try
            ...
            If jObj("OpTareaId") IsNot Nothing Then
                id = Convert.ToInt32(jObj("OpTareaId").ToString())
            ...
            If id <= 0 Then
                Return Json(New With {
                    .success = False,
                    .message = "Debe enviar OpTareaId o id."
                })
            End If
