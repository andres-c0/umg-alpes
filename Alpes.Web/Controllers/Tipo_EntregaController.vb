...
Public Class Tipo_EntregaController
    ...
    Private ReadOnly _servicio As Tipo_EntregaServicio

    Public Sub New()
        _servicio = New Tipo_EntregaServicio()
    End Sub

    Function Index() As ActionResult
        Dim lista As List(Of Tipo_Entrega) = _servicio.Listar()
        Return Json(lista, JsonRequestBehavior.AllowGet)
    End Function

    Function Obtener(ByVal id As Integer) As ActionResult
        Try
            Dim entidad As Tipo_Entrega = _servicio.ObtenerPorId(id)
    ...
    Function Buscar(ByVal criterio As String, ByVal valor As String) As ActionResult
        Try
            Dim lista As List(Of Tipo_Entrega) = _servicio.Buscar(criterio, valor)
    ...
    Function Insertar() As ActionResult
        Try
            ...
            Dim entidad As Tipo_Entrega = JsonConvert.DeserializeObject(Of Tipo_Entrega)(jsonBody)

            Dim idGenerado As Integer = _servicio.Insertar(entidad)

            Return Json(New With {
                .success = True,
                .message = "Tipo_Entrega insertado correctamente.",
                .id = idGenerado
            })
        Catch ex As Exception
            Return Json(New With {
    ...
    Function Actualizar() As ActionResult
        Try
            ...
            Return Json(New With {
                .success = True,
                .message = "Tipo_Entrega actualizado correctamente."
            })
        Catch ex As Exception
            Return Json(New With {
                .success = False,
    ...
    Function Eliminar() As ActionResult
        Try
            ...
            Return Json(New With {
                .success = True,
                .message = "Tipo_Entrega eliminado correctamente."
            })
        Catch ex As Exception
            Return Json(New With {
                .success = False,
