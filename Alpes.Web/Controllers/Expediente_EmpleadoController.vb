...
Public Class Expediente_EmpleadoController
    Inherits Controller

    Private ReadOnly _servicio As Expediente_EmpleadoServicio

    Public Sub New()
        _servicio = New Expediente_EmpleadoServicio()
    End Sub

    Function Index() As ActionResult
        Dim lista As List(Of Expediente_Empleado) = _servicio.Listar()
        Return Json(lista, JsonRequestBehavior.AllowGet)
    End Function

    Function Obtener(ByVal id As Integer) As ActionResult
        Dim entidad As Expediente_Empleado = _servicio.ObtenerPorId(id)
    ...
    Function Insertar() As ActionResult
        Try
            ...
            Dim entidad As Expediente_Empleado = JsonConvert.DeserializeObject(Of Expediente_Empleado)(jsonBody)
