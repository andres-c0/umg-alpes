...
Public Class ConsumoMateriaPrimaController
    ...
    Private ReadOnly _servicio As ConsumoMateriaPrimaServicio

    Public Sub New()
        _servicio = New ConsumoMateriaPrimaServicio()
    End Sub

    Function Index() As ActionResult
        Try
            Dim lista As List(Of ConsumoMateriaPrima) = _servicio.Listar()
    ...
    Function Obtener(ByVal id As Integer) As ActionResult
        Try
            Dim entidad As ConsumoMateriaPrima = _servicio.ObtenerPorId(id)
    ...
    Function Buscar(ByVal criterio As String, ByVal valor As String) As ActionResult
        Try
            Dim lista As List(Of ConsumoMateriaPrima) = _servicio.Buscar(criterio, valor)
    ...
    Function Insertar() As ActionResult
        Try
            ...
            Dim entidad As ConsumoMateriaPrima = JsonConvert.DeserializeObject(Of ConsumoMateriaPrima)(jsonBody)
    ...
    Function Actualizar() As ActionResult
        Try
            ...
            If entidad Is Nothing OrElse entidad.ConsumoId <= 0 Then
                Return Json(New With {
                    .success = False,
                    .message = "Debe enviar ConsumoId para actualizar."
                })
            End If
    ...
    Function Eliminar() As ActionResult
        Try
            ...
            If jObj("ConsumoId") IsNot Nothing Then
                id = Convert.ToInt32(jObj("ConsumoId").ToString())
            ...
            If id <= 0 Then
                Return Json(New With {
                    .success = False,
                    .message = "Debe enviar ConsumoId o id."
                })
            End If
