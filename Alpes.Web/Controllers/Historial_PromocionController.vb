...
Public Class Historial_PromocionController
    Inherits Controller

    Private ReadOnly _servicio As Historial_PromocionServicio

    Public Sub New()
        _servicio = New Historial_PromocionServicio()
    End Sub

    Function Index() As ActionResult
        Dim lista As List(Of Historial_Promocion) = _servicio.Listar()
        Return Json(lista, JsonRequestBehavior.AllowGet)
    End Function

    Function Obtener(ByVal id As Integer) As ActionResult
        Dim entidad As Historial_Promocion = _servicio.ObtenerPorId(id)
        Return Json(entidad, JsonRequestBehavior.AllowGet)
    End Function

    Function Buscar(ByVal criterio As String, ByVal valor As String) As ActionResult
        Dim lista As List(Of Historial_Promocion) = _servicio.Buscar(criterio, valor)
        Return Json(lista, JsonRequestBehavior.AllowGet)
    End Function
    ...
    Function Insertar() As ActionResult
        Try
            ...
            Dim entidad As Historial_Promocion = JsonConvert.DeserializeObject(Of Historial_Promocion)(jsonBody)
