...
Public Class PreferenciaClienteController
    ...
    Function Buscar(ByVal criterio As String, ByVal valor As String) As ActionResult
        Try
            Dim lista As List(Of PreferenciaCliente) = _servicio.Buscar(criterio, valor)
            Return Json(New With {
                .success = True,
                .data = lista
            }, JsonRequestBehavior.AllowGet)
    ...
    Function Actualizar() As ActionResult
        Try
            ...
            If entidad Is Nothing OrElse entidad.PreferenciaId <= 0 Then
                Return Json(New With {
                    .success = False,
                    .message = "Debe enviar PreferenciaId para actualizar."
                })
            End If
    ...
    Function Eliminar() As ActionResult
        Try
            ...
            If jObj("PreferenciaId") IsNot Nothing Then
                id = Convert.ToInt32(jObj("PreferenciaId").ToString())
            ...
            If id <= 0 Then
                Return Json(New With {
                    .success = False,
                    .message = "Debe enviar PreferenciaId o id."
                })
            End If
