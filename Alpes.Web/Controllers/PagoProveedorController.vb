...
Public Class PagoProveedorController
    ...
    Private ReadOnly _servicio As PagoProveedorServicio

    Public Sub New()
        _servicio = New PagoProveedorServicio()
    End Sub

    Function Index() As ActionResult
        Try
            Dim lista As List(Of PagoProveedor) = _servicio.Listar()
    ...
    Function Obtener(ByVal id As Integer) As ActionResult
        Try
            Dim entidad As PagoProveedor = _servicio.ObtenerPorId(id)
    ...
    Function Buscar(ByVal criterio As String, ByVal valor As String) As ActionResult
        Try
            Dim lista As List(Of PagoProveedor) = _servicio.Buscar(criterio, valor)
    ...
    Function Insertar() As ActionResult
        Try
            ...
            Dim entidad As PagoProveedor = JsonConvert.DeserializeObject(Of PagoProveedor)(jsonBody)
    ...
    Function Actualizar() As ActionResult
        Try
            ...
            If entidad Is Nothing OrElse entidad.PagoProveedorId <= 0 Then
                Return Json(New With {
                    .success = False,
                    .message = "Debe enviar PagoProveedorId para actualizar."
                })
            End If
    ...
    Function Eliminar() As ActionResult
        Try
            ...
            If jObj("PagoProveedorId") IsNot Nothing Then
                id = Convert.ToInt32(jObj("PagoProveedorId").ToString())
            ...
            If id <= 0 Then
                Return Json(New With {
                    .success = False,
                    .message = "Debe enviar PagoProveedorId o id."
                })
            End If
