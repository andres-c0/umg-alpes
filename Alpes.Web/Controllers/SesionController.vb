...
Public Class SesionController
    ...
    Private ReadOnly _servicio As SesionServicio

    Public Sub New()
        _servicio = New SesionServicio()
    End Sub
    ...
    Public Function Obtener(ByVal id As Integer) As ActionResult
        Try
            Dim entidad As Sesion = _servicio.ObtenerPorId(id)
    ...
    Public Function Insertar() As ActionResult
        Try
            ...
            Dim entidad As Sesion = JsonConvert.DeserializeObject(Of Sesion)(jsonBody)
    ...
    Public Function Actualizar() As ActionResult
        Try
            ...
            If entidad.SesionId <= 0 Then
                Throw New Exception("Debe enviar un SesionId válido para actualizar.")
            End If
    ...
    Public Function Eliminar() As ActionResult
        Try
            Dim sesionId As Integer = ObtenerSesionIdDesdeRequest()

            If sesionId <= 0 Then
                Throw New Exception("Debe enviar un SesionId válido para eliminar.")
            End If

            _servicio.Eliminar(sesionId)
    ...
    Private Function ObtenerSesionIdDesdeRequest() As Integer
        Dim id As Integer = 0

        If Integer.TryParse(Convert.ToString(Request("SesionId")), id) AndAlso id > 0 Then
            Return id
        End If

        If Integer.TryParse(Convert.ToString(Request("sesion_id")), id) AndAlso id > 0 Then
            Return id
        End If
        ...
        Try
            ...
            Dim token As JToken = obj("SesionId")
    ...
    Private Function LimpiarMensajeError(ByVal mensaje As String) As String
        ...
        If mensaje.Contains("No se encontr") AndAlso mensaje.Contains("Sesion") Then
            If mensaje.Contains("actualizar") Then
                Return "No se encontró el registro a actualizar en Sesion."
            End If

            If mensaje.Contains("eliminar") Then
                Return "No se encontró el registro a eliminar en Sesion."
            End If
        End If
