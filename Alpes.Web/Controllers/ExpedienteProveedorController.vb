...
Public Class ExpedienteProveedorController
    Inherits Controller

    Private ReadOnly _servicio As ExpedienteProveedorServicio

    Public Sub New()
        _servicio = New ExpedienteProveedorServicio()
    End Sub

    Function Index() As ActionResult
        Try
            Dim lista As List(Of ExpedienteProveedor) = _servicio.Listar()
    ...
    Function Obtener(ByVal id As Integer) As ActionResult
        Try
            Dim entidad As ExpedienteProveedor = _servicio.ObtenerPorId(id)
    ...
    Function Buscar(ByVal criterio As String, ByVal valor As String) As ActionResult
        Try
            Dim lista As List(Of ExpedienteProveedor) = _servicio.Buscar(criterio, valor)
            Return Json(New With {
                .success = True,
                .data = lista
            }, JsonRequestBehavior.AllowGet)
    ...
    Function Insertar() As ActionResult
        Try
            ...
            Dim entidad As ExpedienteProveedor = JsonConvert.DeserializeObject(Of ExpedienteProveedor)(jsonBody)
    ...
    Function Actualizar() As ActionResult
        Try
            ...
            If entidad Is Nothing OrElse entidad.ExpedienteProveedorId <= 0 Then
                Return Json(New With {
                    .success = False,
                    .message = "Debe enviar ExpedienteProveedorId para actualizar."
                })
            End If
    ...
    Function Eliminar() As ActionResult
        Try
            ...
            If jObj("ExpedienteProveedorId") IsNot Nothing Then
                id = Convert.ToInt32(jObj("ExpedienteProveedorId").ToString())
            ...
            If id <= 0 Then
                Return Json(New With {
                    .success = False,
                    .message = "Debe enviar ExpedienteProveedorId o id."
                })
            End If
