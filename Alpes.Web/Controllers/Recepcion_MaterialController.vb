...
Public Class Recepcion_MaterialController
    Inherits Controller

    Private ReadOnly _servicio As Recepcion_MaterialServicio

    Public Sub New()
        _servicio = New Recepcion_MaterialServicio()
    End Sub
    ...
    Public Function Obtener(ByVal id As Integer) As ActionResult
        Try
            Dim entidad As Recepcion_Material = _servicio.ObtenerPorId(id)
    ...
    Public Function Insertar() As ActionResult
        Try
            ...
            Dim entidad As Recepcion_Material = JsonConvert.DeserializeObject(Of Recepcion_Material)(jsonBody)
    ...
    Public Function Actualizar() As ActionResult
        Try
            ...
            If entidad.RecepcionMaterialId <= 0 Then
                Throw New Exception("Debe enviar un RecepcionMaterialId válido para actualizar.")
            End If
    ...
    Public Function Eliminar() As ActionResult
        Try
            Dim recepcionMaterialId As Integer = ObtenerRecepcionMaterialIdDesdeRequest()

            If recepcionMaterialId <= 0 Then
                Throw New Exception("Debe enviar un RecepcionMaterialId válido para eliminar.")
            End If

            _servicio.Eliminar(recepcionMaterialId)
    ...
    Private Function ObtenerRecepcionMaterialIdDesdeRequest() As Integer
        Dim id As Integer = 0

        If Integer.TryParse(Convert.ToString(Request("RecepcionMaterialId")), id) AndAlso id > 0 Then
            Return id
        End If

        If Integer.TryParse(Convert.ToString(Request("recepcion_material_id")), id) AndAlso id > 0 Then
            Return id
        End If
        ...
        Try
            ...
            Dim token As JToken = obj("RecepcionMaterialId")

            If token Is Nothing Then
                token = obj("recepcion_material_id")
            End If
