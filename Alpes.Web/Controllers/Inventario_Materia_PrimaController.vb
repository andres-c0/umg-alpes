...
Public Class Movimiento_Materia_PrimaController
    Inherits Controller

    Private ReadOnly _servicio As Movimiento_Materia_PrimaServicio

    Public Sub New()
        _servicio = New Movimiento_Materia_PrimaServicio()
    End Sub
    ...
    Public Function Obtener(ByVal id As Integer) As ActionResult
        Try
            Dim entidad As Movimiento_Materia_Prima = _servicio.ObtenerPorId(id)
    ...
    Public Function Insertar() As ActionResult
        Try
            ...
            Dim entidad As Movimiento_Materia_Prima = JsonConvert.DeserializeObject(Of Movimiento_Materia_Prima)(jsonBody)
    ...
    Public Function Actualizar() As ActionResult
        Try
            ...
            If entidad.MovMpId <= 0 Then
                Throw New Exception("Debe enviar un MovMpId válido para actualizar.")
            End If
    ...
    Public Function Eliminar() As ActionResult
        Try
            Dim movMpId As Integer = ObtenerMovMpIdDesdeRequest()

            If movMpId <= 0 Then
                Throw New Exception("Debe enviar un MovMpId válido para eliminar.")
            End If

            _servicio.Eliminar(movMpId)
    ...
    Private Function ObtenerMovMpIdDesdeRequest() As Integer
        Dim id As Integer = 0

        If Integer.TryParse(Convert.ToString(Request("MovMpId")), id) AndAlso id > 0 Then
            Return id
        End If

        If Integer.TryParse(Convert.ToString(Request("mov_mp_id")), id) AndAlso id > 0 Then
            Return id
        End If
        ...
        Try
            ...
            Dim token As JToken = obj("MovMpId")
    ...
    Private Function LimpiarMensajeError(ByVal mensaje As String) As String
        ...
        If mensaje.Contains("Inventario_Materia_Prima para inv_mp_id") Then
            Return "No existe un registro relacionado en Inventario_Materia_Prima para InvMpId."
        End If

        If mensaje.Contains("registro a actualizar en Movimiento_Materia_Prima") Then
            Return "No se encontró el registro a actualizar en Movimiento_Materia_Prima."
        End If

        If mensaje.Contains("registro a eliminar en Movimiento_Materia_Prima") Then
            Return "No se encontró el registro a eliminar en Movimiento_Materia_Prima."
        End If
