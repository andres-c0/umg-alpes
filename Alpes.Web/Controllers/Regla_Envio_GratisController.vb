...
Public Class Regla_Envio_GratisController
    Inherits Controller

    Private ReadOnly _servicio As Regla_Envio_GratisServicio

    Public Sub New()
        _servicio = New Regla_Envio_GratisServicio()
    End Sub

    Function Index() As ActionResult
        Dim lista As List(Of Regla_Envio_Gratis) = _servicio.Listar()
        Return Json(lista, JsonRequestBehavior.AllowGet)
    End Function

    Function Obtener(ByVal id As Integer) As ActionResult
        Dim entidad As Regla_Envio_Gratis = _servicio.ObtenerPorId(id)
        Return Json(entidad, JsonRequestBehavior.AllowGet)
    End Function

    Function Buscar(ByVal criterio As String, ByVal valor As String) As ActionResult
        Dim lista As List(Of Regla_Envio_Gratis) = _servicio.Buscar(criterio, valor)
        Return Json(lista, JsonRequestBehavior.AllowGet)
    End Function
    ...
    Function Insertar() As ActionResult
        Try
            ...
            Dim entidad As Regla_Envio_Gratis = JsonConvert.DeserializeObject(Of Regla_Envio_Gratis)(jsonBody)
