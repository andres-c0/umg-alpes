...
Public Class Tarifa_EnvioController
    Inherits Controller

    Private ReadOnly _servicio As Tarifa_EnvioServicio

    Public Sub New()
        _servicio = New Tarifa_EnvioServicio()
    End Sub

    Function Index() As ActionResult
        Dim lista As List(Of Tarifa_Envio) = _servicio.Listar()
        Return Json(lista, JsonRequestBehavior.AllowGet)
    End Function

    Function Obtener(ByVal id As Integer) As ActionResult
        Dim entidad As Tarifa_Envio = _servicio.ObtenerPorId(id)
        Return Json(entidad, JsonRequestBehavior.AllowGet)
    End Function

    Function Buscar(ByVal criterio As String, ByVal valor As String) As ActionResult
        Dim lista As List(Of Tarifa_Envio) = _servicio.Buscar(criterio, valor)
        Return Json(lista, JsonRequestBehavior.AllowGet)
    End Function
    ...
    Function Insertar() As ActionResult
        Try
            ...
            Dim entidad As Tarifa_Envio = JsonConvert.DeserializeObject(Of Tarifa_Envio)(jsonBody)
